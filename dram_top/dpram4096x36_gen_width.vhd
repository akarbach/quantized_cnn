...
-------------------------------------------------------------------
 ...
 LIBRARY IEEE;
  ...
  ENTITY dpram4096x36_gen_width IS
  ...
  ARCHITECTURE arch OF dpram4096x36_gen_width IS
    ...
    SIGNAL i1   : std_logic_vector((W*36-1) downto 0) := (others => 'X');
    SIGNAL o1   : std_logic_vector((W*36-1) downto 0) := (others => 'X');
    ...
    SIGNAL i2   : std_logic_vector((W*36-1) downto 0) := (others => 'X');
    SIGNAL o2   : std_logic_vector((W*36-1) downto 0) := (others => 'X');
  BEGIN

    -- Component Instantiation
gen_mem: for i in 0 to W-1 generate
    u1: dpram4096x36
